...
class Admin_Form_Produtovenda extends Twitter_Form
{  
    private $_tipo;
    protected $_exibir;
    protected $_usr;
    ...
    public function init()
    {
        ...
        $quantidade->setLabel('Quantidade em estoque')                
                ->setAttrib('placeholder','Quantidade em estoque')
                ->removeDecorator('HtmlTag')
                ->setAttrib('disabled', $this->_exibir);
        
        $preco = new Zend_Form_Element_Text('precoItem');
        $preco->setLabel('Preço unitário')                
                ->setAttrib('placeholder','Preço unitário')
                ->removeDecorator('HtmlTag')
                ->setAttrib('disabled', $this->_exibir);

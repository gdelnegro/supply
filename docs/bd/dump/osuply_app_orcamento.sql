...
CREATE TABLE `orcamento` (
  ...
  KEY `fk_orcamento_comprador_idx` (`comprador`),
  CONSTRAINT `fk_orcamento_comprador` FOREIGN KEY (`comprador`) REFERENCES `pessoa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION

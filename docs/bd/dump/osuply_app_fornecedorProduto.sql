...
CREATE TABLE `fornecedorProduto` (
  ...
  KEY `fk_fornecedorProduto_Fornecedor_idx` (`fornecedor`),
  CONSTRAINT `fk_fornecedorProduto_Produto` FOREIGN KEY (`produto`) REFERENCES `produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_fornecedorProduto_Fornecedor` FOREIGN KEY (`fornecedor`) REFERENCES `pessoa` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `fornecedorProduto` VALUES (2,2,123,10,1,'CHVFND',NULL,NULL,NULL,NULL),(3,3,120,20,1,'Alicate 1230',NULL,NULL,NULL,NULL),(4,4,1200,12,2,'Alicate 1230',NULL,NULL,NULL,NULL);

...
CREATE TABLE `produtoImagem` (
  ...
  `imagem` int(13) DEFAULT NULL,
  PRIMARY KEY (`produto`),
  KEY `fk_produtoImagem_imagem_idx` (`imagem`),
  CONSTRAINT `fk_produtoImagem_produto` FOREIGN KEY (`produto`) REFERENCES `produto` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_produtoImagem_imagem` FOREIGN KEY (`imagem`) REFERENCES `imagem` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
